      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            from <span className="purple"> Delhi, India.</span> I am a Journalism and Mass Communication student at Bennett University with a passion for advertising and public relations. 
